...
(function() {
  jQuery(function() {
    var asignacions, bonificacions, emptyOption, haberes, personals, subcategorias;
    ...
    $('#_cargas_familiar').prop("disabled", true);
    subcategorias = $('#_subcategorium_id').html();
    emptyOption = $('<option />').attr('value', '');
    $('#_categorium_id').change(function() {
      var categoria, options;
      categoria = $('#_categorium_id :selected').text();
      options = $(subcategorias).filter("optgroup[label='" + categoria + "']").prepend(emptyOption).html();
      if (options) {
        $('#_subcategorium_id').html(options);
        return $('#_subcategorium_id').prop("disabled", false);
      } else {
        $('#_subcategorium_id').prop("disabled", true);
        $('#_subcategorium_id').prop("selectedIndex", 0);
        $('#liquidacion_personal_id').prop("disabled", true);
        $('#liquidacion_personal_id').prop("selectedIndex", 0);
        $('#liquidacion_horas_trabajadas').prop("disabled", true);
        $('#liquidacion_horas_trabajadas').val('');
        $('#liquidacion_remuneracion').val('');
        $('#liquidacion_cantidad_horas_extra').val('');
        $('#liquidacion_horas_extra').val('');
        $('#liquidacion_vacaciones').val('');
        $('#liquidacion_total_imponible').val('');
        $('#liquidacion_total_haberes').val('');
        $('#liquidacion_cantidad_horas_extra').prop("disabled", true);
        $('#liquidacion_asignacion_id').prop("disabled", true);
        $('#liquidacion_asignacion_id').prop("selectedIndex", 0);
        $('#liquidacion_bonificacion_id').prop("disabled", true);
        $('#liquidacion_bonificacion_id').prop("selectedIndex", 0);
        return $('#liquidacion_vacaciones').prop("disabled", true);
      }
    });
    personals = $('#liquidacion_personal_id').html();
    emptyOption = $('<option />').attr('value', '');
    $('#_subcategorium_id').change(function() {
      var options, subcategoria;
      subcategoria = $('#_subcategorium_id :selected').text();
      options = $(personals).filter("optgroup[label='" + subcategoria + "']").prepend(emptyOption).html();
      if (options) {
        $('#liquidacion_personal_id').prop("disabled", false);
        return $('#liquidacion_personal_id').html(options);
      } else {
        $('#liquidacion_personal_id').prop("disabled", true);
        $('#liquidacion_personal_id').prop("selectedIndex", 0);
        $('#liquidacion_horas_trabajadas').prop("disabled", true);
    ...
    $('#liquidacion_personal_id').change(function() {
      var options;
      options = $('#liquidacion_personal_id').val();
      if (options) {
        ...
        return $('#liquidacion_vacaciones').prop("disabled", false);
      } else {
        $('#liquidacion_horas_trabajadas').prop("disabled", true);
        $('#liquidacion_horas_trabajadas').val('');
        $('#liquidacion_cantidad_horas_extra').prop("disabled", true);
    ...
    $('#_subcategorium_id').change(function() {
      ...
      if (options2) {
        ...
        return $('#liquidacion_habere_id').html(options2);
      } else {
        $('#liquidacion_habere_id').prop("disabled", true);
        return $('#liquidacion_habere_id').prop("selectedIndex", 0);
      }
    });
    $('#liquidacion_horas_trabajadas').keyup(function() {
      var hora, sueldo, total;
    ...
    $('#liquidacion_cantidad_horas_extra').keyup(function() {
      var cantidad_hora, sueldo, total;
      ...
      return $('#liquidacion_horas_extra').val(total);
    });
    $('#calculoHaberes').click(function() {
      var asig, bono, hextra, imponible, remuneracion, total, vaca;
      ...
      return $('#liquidacion_total_haberes').val(total);
    });
    $('#calculoHaberes').click(function() {
      var descuento, porcentaje, totalSueldo;
      ...
      return $('#liquidacion_descuento_afp').val(descuento);
    });
    $('#calculoHaberes').click(function() {
      var asig1, asig2, asig3, imponible, num, total;
      ...
      if ($('#numeroCargas').val() === 0) {
        return $('#liquidacion_asignacion_familiar').val(0);
      }
    });
    $('#impuesto').click(function() {
      var imp1, imp2, imp3, imp4, imp5, imp6, imp7, imponible, reb2, reb3, reb4, reb5, reb6, reb7, reb8, total;
      imponible = parseInt($('#liquidacion_total_imponible').val());
      ...
      if (imponible > imp7) {
        ...
        return $('#liquidacion_impuesto').val(total);
      }
    });
    return $('#coffeeScript').click(function() {
      var afp, apv, asgFam, desAdi, desc, imp, isapre, legal, liquido, sindicato, thabere, varios;
      ...
      return $('#liquidacion_liquido_pagar').val(liquido);
    });
  });
  ...
  jQuery(function() {
    ...
    return $('#_categorium_id').change(function() {
      ...
      if (options) {
        ...
        return $('#personal_fecha_ingreso_1i').prop("disabled", false);
      } else {
        ...
        $('#personal_fecha_ingreso_3i').prop("disabled", true);
        $('#personal_fecha_ingreso_2i').prop("disabled", true);
        return $('#personal_fecha_ingreso_1i').prop("disabled", true);
      }
    });
  });
