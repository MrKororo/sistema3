...
(function() {
  jQuery(function() {
    var asignacions, bonificacions, haberes, personals, subcategorias;
    ...
    $('#_categorium_id').change(function() {
      var categoria, options, personals;
      categoria = $('#_categorium_id :selected').text();
      options = $(subcategorias).filter("optgroup[label='" + categoria + "']").html();
      if (options) {
        ...
        $('#liquidacion_habere_id').prop("disabled", true);
        $('#liquidacion_horas_trabajadas').prop("disabled", true);
        return $('#liquidacion_cantidad_horas_extra').prop("disabled", true);
      }
    });
    personals = $('#liquidacion_personal_id').html();
    $('#_subcategorium_id').change(function() {
      ...
      if (options) {
        ...
        return $('#liquidacion_personal_id').empty();
      }
    });
    ...
    $('#_subcategorium_id').change(function() {
      ...
      if (options2) {
        ...
        return $('#liquidacion_habere_id').empty();
      }
    });
    ...
    $('#_subcategorium_id').change(function() {
      ...
      if (options3) {
        ...
        return $('#liquidacion_asignacion_id').empty();
      }
    });
    ...
    $("#_afp_id").change(function() {
      return $("#_afp_id option:selected").map(function() {
        return $("#liquidacion_porcentaje_afp").val($(this).val());
      });
    });
    $('#_afp_id').change(function() {
    ...
    $('#_cargas_familiar').change(function() {
